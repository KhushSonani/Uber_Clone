        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100">
          <div className="p-8 sm:p-10">
            <div className="mb-8 text-center sm:text-left">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-black tracking-tight mb-2">Sign Up</h2>
              <p className="text-gray-500 text-lg">Create your RideSync account</p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col space-y-4 text-center">
              ...
              <Link to="/captain/signup" className="text-sm text-gray-500 hover:text-black transition-colors font-medium">
